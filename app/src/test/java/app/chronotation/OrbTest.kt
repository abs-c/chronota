...
import app.chronotation.feature.today.wheelHit
...
class OrbTest {
    ...
    @Test fun tapUsesPreferenceAndReleasingWithoutSelectionClosesWheel() {
        ...
        compose.setContent { PlanRecordTheme(false) { Box(Modifier.fillMaxSize(), contentAlignment = Alignment.BottomEnd) { FloatingOrb(null, OrbAction.PLAN, { action = it }, {}) } } }
