...
class TimelineSqueezeTest {
    ...
    @Test fun aCloseNeighbourSqueezesTheBlockInFrontOfIt() {
        ...
        compose.setContent { PlanRecordTheme(false) { BrowseScreen(false, state(LocalTime.of(9, 0) to LocalTime.of(9, 1), LocalTime.of(9, 12) to LocalTime.of(9, 13)), {}, {}, {}) } }
    ...
    @Test fun aTouchingNeighbourKeepsTheBlockInItsOwnSlot() {
        ...
        compose.setContent { PlanRecordTheme(false) { BrowseScreen(false, state(LocalTime.of(9, 0) to LocalTime.of(9, 5), LocalTime.of(9, 5) to LocalTime.of(9, 20)), {}, {}, {}) } }
        compose.onNodeWithTag("browse_mode_1").performClick()
        compose.onNodeWithTag("calendar_scale_1").performClick()
        val blocks = blockRects().sortedBy { it.top }
        assertEquals(2, blocks.size)
    ...
    @Test fun onlyGenuinelyOverlappingBlocksGoSideBySide() {
        ...
        compose.setContent { PlanRecordTheme(false) { BrowseScreen(false, state(LocalTime.of(9, 0) to LocalTime.of(9, 10), LocalTime.of(9, 5) to LocalTime.of(9, 15)), {}, {}, {}) } }
        compose.onNodeWithTag("browse_mode_1").performClick()
        compose.onNodeWithTag("calendar_scale_1").performClick()
