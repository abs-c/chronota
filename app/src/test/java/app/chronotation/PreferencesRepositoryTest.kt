...
class PreferencesRepositoryTest {
    ...
    @Test fun unknownPreferenceValueFallsBackWithoutErasingOtherKeys() = runBlocking {
        ...
        try {
            ...
            repository.setTimer(app.chronotation.data.entity.TimerMode.POMODORO, 30, 8, 6)
            assertEquals(app.chronotation.data.entity.TimerMode.POMODORO, repository.preferences.first().timerMode)
