...
import app.chronota.data.backup.BackupFormat
import app.chronota.data.backup.BackupRepository
import app.chronota.data.backup.BackupScheduler
import app.chronota.data.backup.WebDavClient
...
class BackupTest {
    ...
    @Test fun webDavAddressesArePutTogetherWithoutDoublingSlashes() {
        ...
        } catch (error: app.chronota.data.backup.WebDavException) {
