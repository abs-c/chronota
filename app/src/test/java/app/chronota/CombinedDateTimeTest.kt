...
import app.chronota.ui.components.CalendarDialog
import app.chronota.ui.components.ClockDialog
...
class CombinedDateTimeTest {
    ...
    @Test fun clockDialogUsesWheelSelection() {
        ...
        compose.setContent { ChronotaTheme(false) { ClockDialog("Day start", LocalTime.of(4, 0), {}) { result = it } } }
