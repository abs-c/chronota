...
import app.chronotation.feature.today.timerElapsedText
...
fun TimerSheet(timer: TimerSession?, categories: List<Category>, plans: List<Plan>, initialPlan: Long?, initialMode: TimerMode,
    ...
    cancel: () -> Unit, finish: () -> Unit, definitions: List<PropertyDefinition> = emptyList(), planValues: List<PlanPropertyValue> = emptyList(), timerPreferences: app.chronotation.data.repository.AppPreferences = app.chronotation.data.repository.AppPreferences()) {
