...
import app.chronotation.ui.components.PressIndication
...
@Composable
fun PlanRecordTheme(dark: Boolean, content: @Composable () -> Unit) {
    MaterialTheme(
        colorScheme = if (dark) DarkColors else LightColors,
        typography = PlanRecordTypography,
        shapes = PlanRecordShapes,
    ) {
