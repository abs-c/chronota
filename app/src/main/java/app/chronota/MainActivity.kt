...
import app.chronota.feature.settings.SettingsViewModel
...
class MainActivity : ComponentActivity() {
    override fun onResume() {
        super.onResume()
        val app = application as ChronotaApplication
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            val settings: SettingsViewModel = viewModel(
                factory = SettingsViewModel.factory((application as ChronotaApplication).preferencesRepository),
            )
            ...
            androidx.compose.runtime.CompositionLocalProvider(
                ...
                app.chronota.ui.components.LocalDisplayPreferences provides resolved,
            ) {
                ChronotaTheme(dark) {
                    ChronotaApp(resolved.themeMode, settings::setTheme, snackbar)
                }
            }
        }
    }
